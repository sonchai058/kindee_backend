...
var ShopPromotions = {
	...
	loadPreview: function(id){
		$.ajax({
			method: 'GET',
			url: site_url('restaurant/shop_promotions/preview/'+ id),
	...
	saveFormData: function(){
		var frm_action = site_url('restaurant/shop_promotions/save');
	...
	saveEditForm: function(){
		...
		var frm_action = site_url('restaurant/shop_promotions/update');
	...
	deleteRecord: function(){
		var frm_action = site_url('restaurant/shop_promotions/del');
		...
		$.ajax({
			...
			success: function (results) {
				if(results.is_successful){
					alert_type = 'success';
					setTimeout(function(){
						$(window.location).attr('href', site_url('restaurant/shop_promotions/index/'+ this.current_page));
					}, 500);
				}else{
					alert_type = 'danger';
				}
...
$(document).ready(function() {
	...
	$('#btnSave').click(function() {
		$('#addModal').modal('hide');
		ShopPromotions.saveFormData();
		return false;
	});//click

	$('#btnSaveEdit').click(function() {
		return ShopPromotions.validateFormEdit();
	});//click
	...
	if(typeof param_current_page != 'undefined'){
		ShopPromotions.current_page = Math.abs(param_current_page);
	}
	...
	$(document).on('click','.btn-delete-row', function(){
		...
		ShopPromotions.confirmDelete(pShopId,  row_num);
	});//click

	$(document).on('click','#btn_confirm_delete', function(){
		ShopPromotions.deleteRecord();
	});
