							...
							<tbody>
								<tr parser-repeat="[data_list]" id="row_{record_number}">
									...
									<td class="td-actions text-center">
										...
										<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger" data-toggle="tooltip" title="ลบรายการนี้" data-shop_id="{encrypt_shop_id}" data-row-number="{record_number}">
