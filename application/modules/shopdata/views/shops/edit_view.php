	...
	-->
		<div class="card-body">
			...
			-->
				...
				<div class="row">
					<div class="col-sm-12 col-md-12">
	                    <input id="searchInput" name="searchInput" class="form-control controls" type="text" placeholder="ค้นหาตำแหน่ง" style="width: 500px !important; margin-top: 5px;" onclick="$(this).select()">
