						...
						<div class="container">
							<div class="form-row justify-content-between">
								...
								<div class="form-group col-md-4 ">
									...
									<div class="form-group has-success">
										<select id="type_id" name="type_id" value="">
							...
							<div class="row rmat_content_tmp" style="display: none">
								...
								<div class="col-sm-12 col-md-4">
									...
									<button onclick='del(this)' style="margin-top:7px;" type="button" class="btn btn-warning btn-sm btn-del" data-toggle="modal" data-target="">
										ลบ
									</button>
								</div>
							</div>
