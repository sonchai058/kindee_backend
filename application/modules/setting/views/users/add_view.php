			...
			<form class="form-horizontal" id="formAdd" accept-charset="utf-8">
				...
				<div class="row">
					<div class="col-sm-12 col-md-4">
						<label class="col-sm-12 control-label" for="title_name">คำนำหน้าชื่อ  :</label>
						<input type="text" class="form-control " id="title_name" name="title_name" value=""  />
					</div>

					<div class="col-sm-12 col-md-4">
						<label class="col-sm-12 control-label" for="user_fname">ชื่อ  :</label>
						<input type="text" class="form-control " id="user_fname" name="user_fname" value=""  />
					</div>
					
					<div class="col-sm-12 col-md-4">
						<label class="col-sm-12 control-label" for="user_lname">นามสกุล  :</label>
						<div class="col-sm-10">
				...
				<div class="row">
					<div class="col-sm-12 col-md-4">
						...
						<select  id="goal_reduce_weight_select" name="" value="ลด">
				...
				<div class="row">
					...
					<div class="col-sm-12 col-md-4">
						<label class="col-sm-12 control-label" for="user_level">ระดับผู้ใช้งาน  :</label><br/>
