		...
		<div class="row">
			...
			<div class="col-sm-12 col-md-9">
				<form class="form-inline well well-sm" name="formSearch" method="post" action="{page_url}/search">
					...
					<option value="user_id">รหัสไอดีหลัก</option>
						</select>
 					</div>
					<div class="form-group">
			...
			<div class="col-sm-12 col-md-3">
				<div class="pull-right text-right">
					...
					<option value="user_id|asc">รหัสไอดีหลัก น้อย - มาก</option><option value="user_id|desc">รหัสไอดีหลัก มาก - น้อย</option>
						</select>
 					</div>
				</div>
			</div>
			...
			<table class="table table-bordered table-striped table-hover">
				<thead class="info">
					<tr bgcolor="#dddddd">
						...
						<th>เคยตรวจ Food Intolerance หรือไม่</th>
