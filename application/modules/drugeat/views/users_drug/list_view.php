<script>
	var alert_arr = JSON.parse('{alert}');
</script>
...
<!--	
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ ข้อมูล<b>users_drug</b></h3>
	</div>
-->
	<div class="card-body">
		<div class="row">
							...
							<div class="btn-group pull-right">
								...
								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-warning btn-sm"
									data-toggle="tooltip" title="ลบรายการนี้"
									 data-drug_id = "{encrypt_drug_id}" data-row-number="{record_number}">
...
<label class="col-sm-3 text-right badge badge-warning" for="edit_remark">ระบุเหตุผล :</label>
			...
			-->
					<input type="hidden" name="encrypt_drug_id" />
