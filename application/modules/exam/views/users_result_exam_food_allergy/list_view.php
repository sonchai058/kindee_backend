...
<!--	
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ ข้อมูล<b>users_result_exam_food_allergy</b></h3>
	</div>
-->
	<div class="card-body">
		<div class="row">
			...
			<div class="col-sm-12 col-md-3">
				<div class="pull-right text-right">
					...
					<option value="alg_id|asc">รหัสอาหารที่แพ้ น้อย - มาก</option><option value="alg_id|desc">รหัสอาหารที่แพ้ มาก - น้อย</option><option value="user_update|asc">ผู้อัปเดต น้อย - มาก</option><option value="user_update|desc">ผู้อัปเดต มาก - น้อย</option><option value="food_alg_val|asc">ค่า ต่ำ - สูง</option><option value="food_alg_val|desc">ค่า สูง - ต่ำ</option>
						</select>
 					</div>
				</div>
			</div>
