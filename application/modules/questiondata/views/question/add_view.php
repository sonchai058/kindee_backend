						...
						<div class="container">
							<div class="form-row justify-content-between">
								<div class="form-group col-md-4 ">
									...
									<div class="form-group has-success">
										<input type="text" class="form-control " id="question_name" name="question_name" value="" />
									</div>
								</div>
								<div class="form-group col-md-4 ">
							...
							<div class="form-row ustify-content-between">
								<div class="form-group col-md-12 ">
									...
									<div class="form-group has-success">
										<textarea class="form-control" id="question_detail" name="question_detail" rows="5"></textarea>
									</div>
								</div>
							</div>
