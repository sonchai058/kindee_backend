		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header card-header-success card-header-icon">
					...
					<h4 class="card-title">รายการข่าว/บทความ</h4>
				</div>
				<div class="card-body">
					<div class="row">
						...
						<table class="table table-striped">
							<thead>
								<tr>
									...
									<th class="text-center">วันที่แสดง</th>
							...
							<tbody>
								<tr parser-repeat="[data_list]" id="row_{record_number}">
									...
									<td style="text-align:center;">{blog_name}</td>
									...
									<td class="td-actions text-center">
										...
										<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger" data-toggle="tooltip" title="ลบรายการนี้" data-blog_id="{encrypt_blog_id}" data-row-number="{record_number}">
