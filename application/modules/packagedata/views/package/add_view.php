						...
						<div class="container">
							...
							<div class="form-row ustify-content-between">
								<div class="form-group col-md-12 ">
									<label class="control-label" for="package_detail">รายละเอียด :</label>
									<div class="form-group has-success">
									<textarea class="form-control" id="package_detail" name="package_detail" rows="5"></textarea>
									</div>
								</div>
							</div>
							<div class="form-row ustify-content-between">
								<div class="form-group col-md-12 ">
									<label class="control-label" for="package_name">แนบหลักฐานสลิป :</label>
									<div class="form-group has-success">
