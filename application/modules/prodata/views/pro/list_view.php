		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header card-header-success card-header-icon">
					...
					<h4 class="card-title">รายการบัตรเครดิต</h4>
				</div>
				<div class="card-body">
									...
									<div class="col-md-2">
										<div class="form-group has-warning bmd-form-group" id="search">
											<select class="select2-search" name="search_field" class="span2">
												<option value="pro_name">บัตรเครดิต</option>
												<option value="pro_type">ประเภท</option>
											</select>
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group has-warning bmd-form-group">
											<input type="text" class="form-control col" id="txtSearch" name="txtSearch" value="<?php
																																if ($txt_search == 'credit_cart') {
																																	echo 'บัตรเครดิต';
																																} elseif ($txt_search == 'mobile_chanel') {
																																	echo 'เครือข่ายโทรศัพท์';
																																} else {
																																	echo $txt_search;
																																}
																																?>">
									...
									<div class="col-md-2">
										<div class="form-group bmd-form-group">
											<select class="select2-search" id="set_order_by" class="span2" value="{order_by}">
												...
												<option value="pro_name|asc">หัวข้อ ก - ฮ</option>
												<option value="pro_name|desc">หัวข้อ ฮ - ก</option>
												<option value="pro_type|asc">ประเภท ก - ฮ</option>
												<option value="pro_type|desc">ประเภท ฮ - ก</option>
							...
							<tbody>
								<tr parser-repeat="[data_list]" id="row_{record_number}">
									...
									<td class="td-actions text-center">
										...
										<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger" data-toggle="tooltip" title="ลบรายการนี้" data-pro_id="{encrypt_pro_id}" data-row-number="{record_number}">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id="formDelete">
					<input type="hidden" name="encrypt_pro_id" />
